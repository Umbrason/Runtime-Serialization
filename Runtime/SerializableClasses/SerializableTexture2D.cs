...
[Serializable]
public class SerializableTexture2D : IXmlSerializable, ISerializable
{
    ...
    protected SerializableTexture2D(SerializationInfo info, StreamingContext context)
    {
        var byteArray = (byte[])info.GetValue("p", typeof(byte[]));
        ImageConversion.LoadImage(texture, byteArray);
    }

    public void GetObjectData(SerializationInfo info, StreamingContext context)
    {
        info.AddValue("p", ImageConversion.EncodeToPNG(texture));
    }

            ...
            foreach (Grendgine_Collada_Geometry geo in Collada.Library_Geometries.Geometry)
            {
                ...
                foreach (Grendgine_Collada_Triangles triangleArray in geo.Mesh.Triangles)
                {
                    ...
                    for (int t = 0; t < triangleCount * 3; t++)
                    {
                        ...
                        vertices[t] = VectorMath.RoundToDigits(vertices[t], 5);
                        vertices[t] -= pivot;
                        ...
                        normals[t] = VectorMath.RoundToDigits(normals[t], 5);
                        ...
                        uv0[triangles[sourceIndex / stride]] = VectorMath.RoundToDigits(uv0[triangles[sourceIndex / stride]], 5);
